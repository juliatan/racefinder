$(document).ready(function(){
  ...
  if($('#map').length > 0) {
    ...
    $.get('/races.json?marathon=' + $('#map').data('marathon'), function(marathon){
      ...
      $.get('/hotels.json?arrival=' + $('#map').data('arrival') + '&departure=' + $('#map').data('departure') + '&preferred_location=' + $('#map').data('preferred-location') + '&marathon=' + $('#map').data('marathon'), function(hotels){
