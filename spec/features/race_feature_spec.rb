...
describe 'Map listing for race' do
  ...
  it 'can display a hotel name', js: true do
    ...
    within '.hotel-info-container' do
      expect(page).to have_content 'Hotel1'
    end
  end
  ...
  it 'shows one picture of the hotel', js: true do
    Hotel.create!(race_id: 3, name: 'Hotel1', price: 150, lat: 52.50927, long: 13.37374, ref_lat: 52.51415, ref_long: 13.36368, image1: "http://i.telegraph.co.uk/multimedia/archive/01836/ritz_1836745a.png")
    enter_race_details
    sleep 5
    page.execute_script("google.maps.event.trigger(window.map.markers[2], 'click');")
